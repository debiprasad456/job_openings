                      ...
                      {paginated.map((app, idx) => {
                        ...
                        return (
                          <tr key={app.id} role="row">
                            ...
                            <td>
                              <div className="admin-app-name">{app.personalInfo?.name || '—'}</div>
                              ...
                              <div style={{ display:'flex', gap:'var(--space-2)' }}>
                                {app.resumeUrl && (
                                  <a
                                    ...
                                    title={`Download Resume: ${app.resumeName || 'resume.pdf'}`}
                                    style={{ fontSize:'var(--text-md)', textDecoration:'none' }}
                                    aria-label={`Download Resume: ${app.resumeName}`}
                                  >
                                    📄
                                  </a>
                                )}
